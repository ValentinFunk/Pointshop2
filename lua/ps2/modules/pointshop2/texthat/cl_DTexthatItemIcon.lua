...
function PANEL:Paint( w, h )
    ...
    draw.SimpleTextOutlined( "Text Hat", self:GetSkin().TextFont, w / 2, h / 2, self.item.class.color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, self.item.class.outlineColor )
end
